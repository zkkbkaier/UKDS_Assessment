%%%%% Extension method in which only subjective weights of indices are considered (SWEA_method)
clear;
clc;
%%-------------------------------------------------------------------
...
for jj=1:qq        
  ...
  % w=0.5*ws+0.5*wo;               % Comprehensive weights for evalution indices
    ...
    kp=w*k;                                                                 %待评物元xx与评价等级间的关联度;
    [kpmax,j0]=max(kp);                                                     %由最大关联度原则求得评价等级j0;
...
string_1='xx';
xlswrite('OutputData_SWEA.xlsx',{string_1},1,'A1');
xlswrite('OutputData_SWEA.xlsx',data111,1,'A2');

string_2='wo';
xlswrite('OutputData_SWEA.xlsx',{string_2},2,'A1');
xlswrite('OutputData_SWEA.xlsx',data222,2,'A2');

string_3='w';
xlswrite('OutputData_SWEA.xlsx',{string_3},3,'A1');
xlswrite('OutputData_SWEA.xlsx',data333,3,'A2');

string_4='k(i,j)';
xlswrite('OutputData_SWEA.xlsx',{string_4},4,'A1');
xlswrite('OutputData_SWEA.xlsx',data444,4,'A2');

string_5='kp';
xlswrite('OutputData_SWEA.xlsx',{string_5},5,'A1');
xlswrite('OutputData_SWEA.xlsx',data555,5,'A2');

string_6='j0';
xlswrite('OutputData_SWEA.xlsx',{string_6},6,'A1');
xlswrite('OutputData_SWEA.xlsx',data666,6,'A2');

string_7='jstar';
xlswrite('OutputData_SWEA.xlsx',{string_7},7,'A1');
xlswrite('OutputData_SWEA.xlsx',data777,7,'A2');
